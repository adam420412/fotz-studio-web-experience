...
const servicesDropdownData = [
  ...
  { name: { pl: "Facebook Ads", en: "Facebook Ads" }, href: "/facebook-ads" },
  { name: { pl: "Google Ads", en: "Google Ads" }, href: "/google-ads" },
  ...
  { name: { pl: "Wizualizacje 3D", en: "3D Visualizations" }, href: "/wizualizacje-3d" },
