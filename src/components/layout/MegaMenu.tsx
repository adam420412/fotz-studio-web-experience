...
const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "E-commerce & Sklepy", href: "/uslugi/strony-internetowe/ecommerce", icon: ShoppingCart, tooltip: "Sklepy internetowe z integracjami" },
      { name: "Pozycjonowanie SEO", href: "/seo/pozycjonowanie", icon: TrendingUp, tooltip: "Wysoka pozycja w wynikach Google" },
  ...
  },
  {
    ...
    color: "#422249",
    items: [
      { name: "Produkcja Filmów", href: "/uslugi/produkcja-filmow", icon: Film, tooltip: "Filmy promocyjne i korporacyjne" },
      { name: "Spoty Reklamowe", href: "/uslugi/produkcja-video", icon: Clapperboard, tooltip: "Krótkie formy reklamowe" },
      { name: "Wizualizacje 3D", href: "/wizualizacje-3d", icon: Box, tooltip: "Renderingi produktów i architektury" },
      { name: "Fotografia", href: "/uslugi/fotografia", icon: Camera, tooltip: "Sesje zdjęciowe produktowe i eventowe" },
  ...
  },
  {
    ...
    color: "#75143F",
    items: [
      { name: "Identyfikacja wizualna", href: "/uslugi/branding", icon: Fingerprint, tooltip: "Logo, kolory, typografia marki" },
