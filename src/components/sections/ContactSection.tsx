  ...
  return (
    <section className="py-20 bg-gradient-to-b from-card/30 to-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-0 w-72 h-72 bg-secondary/10 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <FadeInView delay={0.1}>
            <motion.div 
              className="bg-background/80 backdrop-blur-sm border border-border/50 rounded-2xl p-8"
            ...
            <div className="space-y-6">
              ...
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  className="flex items-start gap-4 p-6 bg-background/80 backdrop-blur-sm border border-border/50 rounded-xl hover:border-primary/30 transition-all group"
              ...
              {/* Quick CTA */}
              <motion.div 
                className="p-6 bg-gradient-to-br from-primary/10 to-secondary/10 border border-border/50 rounded-xl"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.4 }}
              >
                <h4 className="font-semibold mb-2">Wolisz porozmawiać?</h4>
