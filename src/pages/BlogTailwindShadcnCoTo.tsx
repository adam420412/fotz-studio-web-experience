...
export default function BlogTailwindShadcnCoTo() {
  return (
    <Layout>
      <SEOHead
        title="Tailwind CSS, shadcn/ui, Radix UI, Mantine — biblioteki UI React 2024 | Fotz.pl"
        ...
        canonicalUrl="https://fotz.pl/blog/tailwind-css-shadcn-ui-radix-mantine-biblioteki-ui-react-2024"
        ...
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs
            items={[
              ...
              { label: "Tailwind CSS i shadcn/ui", href: "/blog/tailwind-css-shadcn-ui-radix-mantine-biblioteki-ui-react-2024" },
            ]}
          />
          <div className="mt-8">
