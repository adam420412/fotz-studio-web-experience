...
export default function BlogStorybook8CoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-rose-950 to-pink-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Storybook 8 i CDD", url: "/blog/storybook-8-csf-vitest-autodocs-chromatic-component-driven-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="storybook-8-csf-vitest-autodocs-chromatic-component-driven-2024" />
      <ContactSection />
    </Layout>
  );
}
