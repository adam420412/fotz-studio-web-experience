...
export default function BlogCssCustomPropsCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-violet-950 to-purple-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "CSS Custom Properties", url: "/blog/css-custom-properties-variables-design-tokens-theming-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="css-custom-properties-variables-design-tokens-theming-2024" />
      <ContactSection />
    </Layout>
  );
}
