...
export default function BlogMonorepoCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-cyan-950 to-teal-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Monorepo", url: "/blog/monorepo-co-to-jest-nx-turborepo-pnpm-workspaces-nx-cloud" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="monorepo-co-to-jest-nx-turborepo-pnpm-workspaces-nx-cloud" />
      <ContactSection />
    </Layout>
  );
}
