  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="MEDDIC — definicja, 6 elementów (Metrics, Economic Buyer, Decision Criteria, Decision Process, Pain, Champion), porównanie z BANT i deal scoring. Kompletny przewodnik."
