...
export default function BlogTanstackRouterCoTo() {
  return (
    <Layout>
      <SEOHead
        title="TanStack Router, React Router v7 i type-safe routing w React 2024 | Fotz.pl"
        description="TanStack Router (100% type-safe, file-based), React Router v7 (Remix merger, loaders, actions), Wouter (1.5KB), Next.js App Router i type-safe navigation z TypeScript."
