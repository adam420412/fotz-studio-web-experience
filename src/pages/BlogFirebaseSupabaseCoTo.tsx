...
export default function BlogFirebaseSupabaseCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-amber-950 to-yellow-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Firebase vs Supabase", url: "/blog/firebase-supabase-convex-baas-porownanie-co-wybrac-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="firebase-supabase-convex-baas-porownanie-co-wybrac-2024" />
      <ContactSection />
    </Layout>
  );
}
