...
export default function BlogSolidJsCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-cyan-950 to-blue-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "SolidJS", url: "/blog/solidjs-fine-grained-reactivity-createsignal-solidstart-vs-react-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="solidjs-fine-grained-reactivity-createsignal-solidstart-vs-react-2024" />
      <ContactSection />
    </Layout>
  );
}
