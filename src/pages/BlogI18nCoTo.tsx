...
export default function BlogI18nCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-sky-950 to-blue-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "i18n Internationalization", url: "/blog/i18n-internationalization-next-intl-react-i18next-nextjs-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="i18n-internationalization-next-intl-react-i18next-nextjs-2024" />
      <ContactSection />
    </Layout>
  );
}
