...
export default function BlogLocalFirstCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-green-950 to-emerald-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Local-First Software 2024", url: "/blog/local-first-jazz-tools-powersync-electricsql-dexie-pglite-offline-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="local-first-jazz-tools-powersync-electricsql-dexie-pglite-offline-2024" />
      <ContactSection />
    </Layout>
  );
}
