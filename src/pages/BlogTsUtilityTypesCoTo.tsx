...
export default function BlogTsUtilityTypesCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-indigo-950 to-blue-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "TypeScript Utility Types", url: "/blog/typescript-utility-types-partial-returntype-conditional-mapped-branded-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="typescript-utility-types-partial-returntype-conditional-mapped-branded-2024" />
      <ContactSection />
    </Layout>
  );
}
