...
const features = [
  { icon: Smartphone, title: "Responsywny design", desc: "Mobile-first — ponad 60% zakupów online w Krakowie odbywa się na telefonie. Twój sklep musi wyglądać i działać perfekcyjnie na każdym urządzeniu." },
...
const faqItems = [
  ...
  {
    question: "Czy agencja z Poznania może tworzyć sklep dla firmy z Krakowa?",
    answer: "Oczywiście — pracujemy zdalnie z firmami z całej Polski. Kraków to jedno z miast, z którymi współpracujemy regularnie, szczególnie w branżach tech, artystycznej i turystycznej. Spotkania prowadzimy online, jeśli projekt tego wymaga — przyjeżdżamy."
  },
  {
  ...
  {
    question: "Czy zajmujecie się też SEO i marketingiem dla sklepów z Krakowa?",
    answer: "Tak — po wdrożeniu oferujemy pozycjonowanie sklepu (SEO e-commerce), kampanie Google Shopping, Meta Ads i email marketing. Krakowski rynek e-commerce jest dynamiczny, szczególnie w branżach związanych z turystyką, rzemiosłem i gastronomią."
  },
  {
  ...
  {
    question: "Czy po uruchomieniu sklepu mogę samodzielnie zarządzać produktami?",
    answer: "Oczywiście — wszystkie nasze sklepy mają intuicyjny panel administracyjny. Dostarczamy szkolenie online z obsługi systemu, dokumentację i wsparcie w pierwszych miesiącach po starcie."
  }
];
...
export default function SklepyInternetoweKrakow() {
  return (
    <Layout>
      <SEOHead
        title="Sklepy Internetowe Kraków | E-commerce dla firm | Fotz Studio"
        description="Tworzymy sklepy internetowe dla firm z Krakowa. Shopify, WooCommerce, PrestaShop i custom e-commerce. Integracje płatności, dostaw i SEO. Bezpłatna wycena."
        canonical="https://fotz.pl/uslugi/sklepy-internetowe/krakow"
        keywords="sklepy internetowe Kraków, tworzenie sklepu internetowego Kraków, e-commerce Kraków, sklep online Kraków, Shopify Kraków, WooCommerce Kraków, sklep www Kraków, agencja e-commerce Kraków"
      />

      <ServiceSchema
        name="Sklepy Internetowe Kraków"
        description="Tworzenie sklepów internetowych dla firm z Krakowa — Shopify, WooCommerce, PrestaShop i dedykowane rozwiązania e-commerce."
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Sklepy Internetowe Kraków", url: "https://fotz.pl/uslugi/sklepy-internetowe/krakow" }
        ]}
      />
          ...
          >
            <motion.div variants={fadeIn} className="mb-4">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#75143F]/20 border border-[#75143F]/30 text-sm text-foreground/80">
                <MapPin className="w-4 h-4" /> Kraków i Małopolska
              </span>
            </motion.div>
            ...
            <motion.p variants={fadeIn} className="text-lg md:text-xl text-muted-foreground mb-6 max-w-2xl mx-auto">
              Tworzymy profesjonalne sklepy internetowe dla firm z Krakowa i Małopolski.
              Od wyboru platformy, przez projekt UX/UI, po integracje płatności, dostaw i SEO — kompleksowo.
            </motion.p>

            <motion.p variants={fadeIn} className="text-base text-muted-foreground/80 mb-10 max-w-xl mx-auto">
              Kraków to centrum technologiczne z dynamicznym rynkiem e-commerce — tutaj jakość wykonania
              i optymalizacja konwersji mają kluczowe znaczenie dla sukcesu sklepu.
            </motion.p>
        ...
        <div className="container px-4">
          ...
          >
            {[
              ...
              { value: "Cała PL", label: "zasięg naszej agencji" }
            ].map((s, i) => (
        ...
        <div className="container px-4">
          ...
          >
            <motion.h2 variants={fadeIn} className="text-3xl md:text-4xl font-heading font-bold text-white mb-4">
              Gotowy na własny sklep w Krakowie?
            </motion.h2>
            <motion.p variants={fadeIn} className="text-white/80 mb-8">
              ...
              Pracujemy z klientami z całej Polski.
            </motion.p>
            <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              { label: "SEO dla e-commerce", to: "/seo/ecommerce" },
            ].map((link) => (
              <Link
                key={link.to}
                to={link.to}
