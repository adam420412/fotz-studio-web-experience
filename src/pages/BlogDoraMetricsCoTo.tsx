...
export default function BlogDoraMetricsCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "DORA Metrics", url: "/blog/dora-metrics-co-to-jest-jak-mierzyc-wydajnosc-devops" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="dora-metrics-co-to-jest-jak-mierzyc-wydajnosc-devops" />
      <ContactSection />
    </Layout>
  );
}
