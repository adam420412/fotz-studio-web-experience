  ...
  return (
    <>
      ...
      <Layout>
        ...
        <ContactSection
          heading="Wypozycjonuj swoją firmę lokalnie w Google"
          subheading="Strona z SEO lokalnym, Google Maps i schema markup — pojawiaj się gdy klienci szukają Cię w pobliżu."
        />
      </Layout>
    </>
  );
