  ...
  return (
    <>
      ...
      <Layout>
        ...
        <ContactSection
          heading="Pomożemy zbudować landing page i MVP marketing"
          subheading="Szybkie strony internetowe i kampanie — pomagamy startupom testować pomysły i zdobywać pierwszych klientów."
        />
      </Layout>
    </>
  );
