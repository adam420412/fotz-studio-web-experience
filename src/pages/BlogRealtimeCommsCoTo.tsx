...
export default function BlogRealtimeCommsCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-emerald-950 to-teal-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Real-time komunikacja", url: "/blog/websocket-sse-long-polling-real-time-komunikacja-socket-io-mqtt" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="websocket-sse-long-polling-real-time-komunikacja-socket-io-mqtt" />
      <ContactSection />
    </Layout>
  );
}
