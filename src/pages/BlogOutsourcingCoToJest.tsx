  ...
  return (
    <>
      ...
      <Layout>
        ...
        <ContactSection
          heading="Outsourcuj tworzenie stron internetowych do nas"
          subheading="Zajmujemy sie calym procesem — od projektu po wdrozenie i SEO. Ty skupiasz sie na biznesie."
        />
      </Layout>
    </>
  );
