    ...
    <Layout>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">
              Case study Lauvjah — Strona internetowa i SEO dla transportu i spedycji
            </h2>
            <p className="text-muted-foreground mb-4">
              Projekt dla Lauvjah to przykład, jak profesjonalne strona internetowa i seo przekłada się
              na realne wyniki biznesowe. Nowa strona z silnym SEO pozwoliła firmie transportowej pozyskiwać klientów z organicznego wyszukiwania. Fotz Studio realizuje podobne projekty
              dla firm z branży transportu i spedycji i pokrewnych — każdorazowo z indywidualnym podejściem
            ...
            <h2 className="text-3xl font-heading font-bold mb-6">
              Potrzebujesz podobnego projektu? Sprawdź nasze usługi stron internetowych dla firm transportowych
            </h2>
            <p className="text-muted-foreground">
              Jeśli szukasz partnera do realizacji projektu podobnego do Lauvjah, zapraszamy
