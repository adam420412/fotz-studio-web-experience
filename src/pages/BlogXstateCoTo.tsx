...
export default function BlogXstateCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-rose-950 to-pink-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "XState", url: "/blog/xstate-co-to-jest-maszyna-stanow-statecharts-actor-model-react" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="xstate-co-to-jest-maszyna-stanow-statecharts-actor-model-react" />
      <ContactSection />
    </Layout>
  );
}
