...
export default function BlogObservabilityCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-teal-950 to-slate-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Observability", url: "/blog/observability-co-to-jest-opentelemetry-prometheus-grafana" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="observability-co-to-jest-opentelemetry-prometheus-grafana" />
      <ContactSection />
    </Layout>
  );
}
