...
export default function BlogRateLimitingCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-rose-950 to-pink-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Rate Limiting", url: "/blog/rate-limiting-co-to-jest-token-bucket-redis-nginx-kong-aws-api-gateway" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="rate-limiting-co-to-jest-token-bucket-redis-nginx-kong-aws-api-gateway" />
      <ContactSection />
    </Layout>
  );
}
