...
export default function BlogTauriElectronCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-orange-950 to-yellow-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Tauri i Electron", url: "/blog/tauri-electron-wails-desktop-apps-react-typescript-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="tauri-electron-wails-desktop-apps-react-typescript-2024" />
      <ContactSection />
    </Layout>
  );
}
