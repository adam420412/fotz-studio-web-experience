  ...
  return (
    <Layout>
      <SEOHead
        ...
        keywords="pozycjonowanie zgorzelec, seo zgorzelec, agencja seo zgorzelec, pozycjonowanie lokalne zgorzelec, pozycjonowanie stron zgorzelec, seo dla firm zgorzelec"
      />
