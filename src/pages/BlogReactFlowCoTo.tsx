...
export default function BlogReactFlowCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "React Flow i Graph Viz", url: "/blog/react-flow-xyflow-mermaid-graph-visualization-diagramy-react-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="react-flow-xyflow-mermaid-graph-visualization-diagramy-react-2024" />
      <ContactSection />
    </Layout>
  );
}
