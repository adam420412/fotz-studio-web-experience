...
export default function BlogNextFontCoTo() {
  return (
    <Layout>
      <SEOHead
        title="next/font, Variable Fonts, FOUT/FOIT i Font Optimization — Next.js 2024 | Fotz.pl"
        description="next/font (Google Fonts self-hosting, CLS=0, size-adjust), variable fonts (wght oś), font-display: optional, FOUT/FOIT eliminacja i Fontsource — optymalizacja fontów."
        ...
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs
            items={[
              ...
              { label: "Font Optimization Next.js", href: "/blog/nextjs-font-optimization-variable-fonts-fout-foit-google-fonts-2024" },
            ]}
          />
          <div className="mt-8">
