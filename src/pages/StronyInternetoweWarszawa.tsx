...
const StronyInternetoweWarszawa = () => {
  ...
  const cityLinks = [
    ...
    { name: "Kraków", href: "/strony-internetowe-krakow", active: false },
    { name: "Wrocław", href: "/strony-internetowe-wroclaw", active: false },
    { name: "Gdańsk", href: "/strony-internetowe-gdansk", active: false },
