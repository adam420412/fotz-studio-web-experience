...
export default function BlogVitestPlaywrightCoTo() {
  return (
    <Layout>
      <SEOHead
        title="Vitest, Playwright, Cypress, Storybook — testowanie aplikacji React 2024 | Fotz.pl"
        ...
        canonicalUrl="https://fotz.pl/blog/vitest-playwright-cypress-storybook-testowanie-react-2024"
        ...
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs
            items={[
              ...
              { label: "Vitest i Playwright", href: "/blog/vitest-playwright-cypress-storybook-testowanie-react-2024" },
            ]}
          />
          <div className="mt-8">
