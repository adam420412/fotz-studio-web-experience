...
export default function BlogOpenApiCoTo() {
  return (
    <Layout>
      <SEOHead
        title="OpenAPI, Zod, tRPC vs REST, Orval i Scalar — dokumentacja API TypeScript 2024 | Fotz.pl"
        ...
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs
            items={[
              ...
              { label: "OpenAPI TypeScript", href: "/blog/openapi-zod-trpc-orval-scalar-dokumentacja-api-typescript-2024" },
            ]}
          />
          <div className="mt-8">
