  ...
  return (
    <>
      <SEOHead
        ...
        description="Sales enablement co to jest — wyjaśniamy czym jest wsparcie sprzedaży, filary (content, szkolenia, narzędzia), jak mierzyć efektywność i jak zbudować…"
