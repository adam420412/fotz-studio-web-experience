...
export default function BlogTailwindV4CoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-cyan-950 to-teal-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Tailwind CSS v4", url: "/blog/tailwind-css-v4-theme-oxide-engine-oklch-migracja-v3-2025" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="tailwind-css-v4-theme-oxide-engine-oklch-migracja-v3-2025" />
      <ContactSection />
    </Layout>
  );
}
