...
export default function FacebookAdsPoznan() {
  const services = [
    {
      icon: Target,
  ...
  const process = [
    {
      ...
      description: "Sprawdzamy Twoje obecne kampanie Meta, konkurencję i potencjał rynku Poznania. Identyfikujemy oportuności wzrostu."
    },
    {
      number: "2",
      title: "Strategia i Planning",
      description: "Budujemy niestandardową strategię Meta Ads z targetowaniem, budżetem i harmonogramem kampanii dla Poznania."
    },
    {
      number: "3",
  ...
  const industries = [
    ...
    { emoji: '🏢', name: 'B2B Usługi', description: 'Konsulting, doradztwo, outsourcing' },
    ...
    { emoji: '💼', name: 'Usługi Biznesowe', description: 'Rachunkowość, prawo, doradztwo' },
    { emoji: '🎨', name: 'Kreatywny Biznes', description: 'Agencje, fotografia, design' }
  ];

  const areas = [
    'Stare Miasto', 'Nowe Miasto', 'Grunwald', 'Jeżyce', 'Rataje', 'Winogrady', 'Piątkowo', 'Łazarz'
  ];

  const faqs = [
    {
      question: "Jaki budżet na Facebook Ads dla firm z Poznania?",
      answer: "Minimum 400 PLN/mies dla małych firm (patrz plan START). Średnie firmy inwestują 1200-2500 PLN, duże 5000+ PLN. W Poznaniu biznesu B2B czy edukacji rekomendujemy min. 1200 PLN dla efektów."
    },
    {
    ...
    },
    {
      ...
      answer: "Tak, ale inaczej niż dla e-commerce. Musimy budować brand awareness i leadów, nie sprzedaż bezpośrednią. W Poznaniu firmy B2B, konsulting czy edukacja mają świetne wyniki z lead generation."
    },
    {
    ...
    {
      question: "Ile osób z Poznania możemy osiągnąć reklamami?",
      answer: "W Poznaniu jest ~700k aktywnych użytkowników Facebook/Instagram. W zależności od targeting (wiek, zainteresowania, behawior) możemy dotrzeć do 5k-150k osób/dzień. Bardziej sprecyzowany targeting = wyższy ROI."
    },
    {
              ...
              <FadeInView>
                <div>
                  <h1 className="text-5xl sm:text-6xl font-bold mb-6 leading-tight">
                    Facebook Ads dla Poznania
                  </h1>
                  <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                    Reklamy na Facebook i Instagram, które zamieniają przewijających w klientów. Od e-commerce, przez B2B, po edukację – dla wszystkich marek z Poznania i Wielkopolski.
                  </p>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-blue-100 text-sm">Bez ukrytych opłat. Transparentne ceny dla firm z Poznania.</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-4">
                        <CheckCircle2 className="w-6 h-6 flex-shrink-0 text-green-300 mt-1" />
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  icon: MapPin,
                  title: "Stolica Biznesu Wielkopolski",
                  description: "Poznań to serce biznesu w Wielkopolsce. Firmy B2B, usługi, produkcja. Facebook Ads to sposób na dotarcie do decydentów i kierowników."
                },
                {
                  icon: Zap,
                  title: "Targi MTP i Turystyka Biznesowa",
                  description: "MTP przyciąga biznesmenów z całej Polski. Meta Ads to kanał do promocji, lead generation dla hoteli, restauracji i usług turystycznych."
                },
                {
                  icon: TrendingUp,
                  title: "E-commerce i Sprzedaż",
                  description: "Sklepy online w Poznaniu i regionie. Facebook Ads to sposób na dotarcie do ludzi szukających produktów. Catalog Ads, retargeting – to działa."
                }
              ].map((item, i) => (
          ...
          <div className="max-w-7xl mx-auto px-6">
            <FadeInView>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                  Od audytu do skalowania. Proces, który sprawdzył się dla 150+ kampanii w Poznaniu.
                </p>
              </div>
            </FadeInView>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <FadeInView>
              <div className="text-center mb-16">
                <h2 className="text-4xl font-bold text-gray-900 mb-4">
                  Dzielnice Poznania, które obsługujemy
                </h2>
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                  Facebook Ads dla firm z całego Poznania i Wielkopolski
                </p>
              </div>
            </FadeInView>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6">
            <FadeInView>
              <div className="text-center mb-16">
                <h2 className="text-4xl font-bold text-gray-900 mb-4">
                  Dlaczego firmy z Poznania wybierają FOTZ?
                </h2>
              </div>
            </FadeInView>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: "Nasi account managers pracowali w e-commerce, B2B, edukacji. Znają Twoje wyzwania."
                },
                {
                  icon: Zap,
