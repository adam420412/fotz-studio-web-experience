...
export default function BlogDbMigrationsCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-indigo-950 to-blue-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Database Migrations", url: "/blog/database-migrations-co-to-jest-flyway-liquibase-alembic-zero-downtime-rollback" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="database-migrations-co-to-jest-flyway-liquibase-alembic-zero-downtime-rollback" />
      <ContactSection />
    </Layout>
  );
}
