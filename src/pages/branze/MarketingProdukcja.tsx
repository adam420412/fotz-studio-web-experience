...
import { Factory, ArrowRight, CheckCircle, Globe, Camera, Video, TrendingUp, Cog, Package, Users, Plus } from "lucide-react";
            ...
            >
              <div className="aspect-square rounded-3xl bg-gradient-to-br from-primary/20 to-primary/5 p-8 flex items-center justify-center">
                <div className="text-center">
                  <Factory className="w-24 h-24 text-primary mx-auto mb-6" />
                  <p className="text-2xl font-heading font-bold mb-2">Wzrost przemysłowy</p>
                  <p className="text-foreground/60">wspierany profesjonalnym marketingiem</p>
                </div>
              </div>
            </motion.div>
          </div>
