...
import { Heart, ArrowRight, CheckCircle, Globe, Users, Video, TrendingUp, HandHeart, Megaphone, Target, Plus } from "lucide-react";
            ...
            >
              <div className="aspect-square rounded-3xl bg-gradient-to-br from-primary/20 to-primary/5 p-8 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-2xl font-heading font-bold mb-2">Misja społeczna</p>
                  <p className="text-foreground/60">wspierana profesjonalnym marketingiem</p>
                </div>
              </div>
            </motion.div>
          </div>
