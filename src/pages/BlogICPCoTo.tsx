  ...
  return (
    <>
      ...
      <Layout>
        ...
        <ContactSection
          heading="Zbuduj stronę dopasowaną do Twojego ICP"
          subheading="Messaging, UX i SEO skrojone pod idealnego klienta — pomagamy B2B firmom trafić do właściwych odbiorców."
        />
      </Layout>
    </>
  );
