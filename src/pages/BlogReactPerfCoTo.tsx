...
export default function BlogReactPerfCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-red-950 to-orange-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "React Performance Optimization", url: "/blog/react-performance-scan-million-bundle-analyzer-code-splitting-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="react-performance-scan-million-bundle-analyzer-code-splitting-2024" />
      <ContactSection />
    </Layout>
  );
}
