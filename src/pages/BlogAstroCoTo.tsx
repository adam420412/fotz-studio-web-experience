...
export default function BlogAstroCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-purple-950 to-pink-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Astro, SvelteKit, Remix", url: "/blog/astro-sveltekit-remix-island-architecture-co-to-jest-kiedy-wybrac" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="astro-sveltekit-remix-island-architecture-co-to-jest-kiedy-wybrac" />
      <ContactSection />
    </Layout>
  );
}
