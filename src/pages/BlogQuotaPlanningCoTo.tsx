...
export default function BlogQuotaPlanningCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-emerald-950 to-slate-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Quota Planning", url: "/blog/quota-planning-targetowanie-sprzedazowe-saas" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="quota-planning-targetowanie-sprzedazowe-saas" />
      <ContactSection />
    </Layout>
  );
}
