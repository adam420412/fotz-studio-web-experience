...
export default function BlogFeatureFlagsCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-fuchsia-950 to-purple-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Feature Flags", url: "/blog/feature-flags-co-to-jest-launchdarkly-unleash-ab-testing" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="feature-flags-co-to-jest-launchdarkly-unleash-ab-testing" />
      <ContactSection />
    </Layout>
  );
}
