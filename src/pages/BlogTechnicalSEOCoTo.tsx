  ...
  return (
    <>
      ...
      <Layout>
        ...
        <ContactSection
          heading="Audyt Technical SEO i optymalizacja strony"
          subheading="Core Web Vitals, schema markup i szybkość strony — budujemy strony z doskonałą podstawą techniczną SEO."
        />
      </Layout>
    </>
  );
