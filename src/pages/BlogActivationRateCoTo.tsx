...
export default function BlogActivationRateCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-emerald-950 to-slate-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Activation Rate", url: "/blog/activation-rate-co-to-jest-jak-poprawic-aktywacje" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="activation-rate-co-to-jest-jak-poprawic-aktywacje" />
      <ContactSection />
    </Layout>
  );
}
