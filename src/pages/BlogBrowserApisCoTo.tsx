...
export default function BlogBrowserApisCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-green-950 to-emerald-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Modern Browser APIs", url: "/blog/modern-browser-apis-indexeddb-dexie-web-share-clipboard-file-system-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="modern-browser-apis-indexeddb-dexie-web-share-clipboard-file-system-2024" />
      <ContactSection />
    </Layout>
  );
}
