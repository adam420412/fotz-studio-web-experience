...
export default function BlogDddCoTo() {
  return (
    <Layout>
      <SEOHead
        title="Domain-Driven Design (DDD) — co to jest, Bounded Context, Aggregate, Event Storming? | Fotz.pl"
        ...
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs
            items={[
              ...
              { label: "Domain-Driven Design", href: "/blog/domain-driven-design-ddd-co-to-jest-bounded-context-aggregate-event-storming" },
            ]}
          />
          <div className="mt-8">
