...
export default function BlogRemixDeepDiveCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-pink-950 to-rose-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Remix.js", url: "/blog/remix-nested-routes-loader-action-defer-usefetcher-optimistic-ui-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="remix-nested-routes-loader-action-defer-usefetcher-optimistic-ui-2024" />
      <ContactSection />
    </Layout>
  );
}
