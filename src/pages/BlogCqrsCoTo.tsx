...
export default function BlogCqrsCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "CQRS", url: "/blog/cqrs-command-query-responsibility-segregation-co-to-jest" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="cqrs-command-query-responsibility-segregation-co-to-jest" />
      <ContactSection />
    </Layout>
  );
}
