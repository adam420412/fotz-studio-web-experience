...
export default function BlogReactRouter7CoTo() {
  return (
    <Layout>
      <SEOHead
        title="React Router 7 — Framework Mode, loaders, actions, typegen i vs Next.js 2024 | Fotz.pl"
        description="React Router 7 (Remix v3): Framework Mode (file-based routing, loaders, actions, SSR), Library Mode, typegen, pending states, optimistic UI i porównanie z Next.js, TanStack Start."
        ...
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs
            items={[
              ...
              { label: "React Router 7", href: "/blog/react-router-7-framework-mode-loaders-actions-typegen-vs-nextjs-2024" },
            ]}
          />
          <div className="mt-8">
