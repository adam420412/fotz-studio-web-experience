  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Switching costs (koszty zmiany) — definicja, 6 rodzajów (finansowe, proceduralne, relacyjne, techniczne), jak budować i vendor lock-in. Kompletny…"
      ...
      <RelatedArticles currentArticleId="switching-costs-co-to" />
      <ContactSection />
    </Layout>
  );
}
