  ...
  return (
    <>
      ...
      <Layout>
        ...
        <ContactSection
          heading="Pomozemy Ci zbudowac infrastrukture ABM online"
          subheading="Strony, landing page i SEO — pomagamy firmom B2B pozyskiwac named accounts przez internet."
        />
      </Layout>
    </>
  );
