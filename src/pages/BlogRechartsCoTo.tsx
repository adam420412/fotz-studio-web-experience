...
export default function BlogRechartsCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-teal-950 to-cyan-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Recharts i Data Visualization", url: "/blog/recharts-nivo-chartjs-data-visualization-react-wykresy-mapy-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="recharts-nivo-chartjs-data-visualization-react-wykresy-mapy-2024" />
      <ContactSection />
    </Layout>
  );
}
