  ...
  return (
    <>
      ...
      <Layout>
        ...
        <ContactSection
          heading="Zwieksz przychody i popraw plynnosc przez lepszy marketing"
          subheading="Wiecej klientow z internetu = szybszy cashflow. Tworzymy strony ktore przynoszaja leady."
        />
      </Layout>
    </>
  );
