...
export default function BlogGithubActionsAdvCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-gray-900 to-zinc-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "GitHub Actions zaawansowane", url: "/blog/github-actions-changesets-semantic-release-oidc-optymalizacja-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="github-actions-changesets-semantic-release-oidc-optymalizacja-2024" />
      <ContactSection />
    </Layout>
  );
}
