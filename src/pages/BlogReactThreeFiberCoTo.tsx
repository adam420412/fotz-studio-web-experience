...
export default function BlogReactThreeFiberCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-violet-950 to-indigo-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "React Three Fiber 3D", url: "/blog/react-three-fiber-drei-3d-threejs-fizyka-webxr-react-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="react-three-fiber-drei-3d-threejs-fizyka-webxr-react-2024" />
      <ContactSection />
    </Layout>
  );
}
