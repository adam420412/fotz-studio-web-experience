  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Pivot — definicja, 6 typów pivotów (Zoom-In, Customer Segment, Platform i in.), sygnały że czas na zmianę i jak zakomunikować inwestorom. Przewodnik dla startupów."
