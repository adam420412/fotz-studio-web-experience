...
export default function BlogReactErrorHandlingCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-red-950 to-orange-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "React Error Handling", url: "/blog/react-error-handling-error-boundary-sentry-tanstack-query-nextjs-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="react-error-handling-error-boundary-sentry-tanstack-query-nextjs-2024" />
      <ContactSection />
    </Layout>
  );
}
