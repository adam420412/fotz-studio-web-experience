          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <Link
                key={service.name}
                to={service.href}
                className="group p-6 rounded-xl border border-border bg-card hover:border-red-500/50 transition-all"
              >
                <h3 className="font-semibold mb-2 group-hover:text-red-400 transition-colors">
                  {service.name}
                </h3>
                <p className="text-muted-foreground text-sm mb-4">{service.description}</p>
                <span className="text-red-400 text-sm flex items-center gap-1 group-hover:gap-2 transition-all">
