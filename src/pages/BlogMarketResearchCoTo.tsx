  ...
  return (
    <>
      <SEOHead
        ...
        description="Market research co to jest — wyjaśniamy czym jest badanie rynku, metody (IDI, ankiety, desk research), ile kosztuje, narzędzia i zastosowania w strategii…"
