    ...
    <Layout>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="rounded-2xl overflow-hidden border border-border/30">
                <img loading="lazy" src={grafImg} alt="Graf Tapicerstwo - strona internetowa" className="w-full" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">
              Case study Graf Tapicerstwo — Strona internetowa z galerią realizacji dla usług motoryzacyjnych i tapicerstwa
            </h2>
            <p className="text-muted-foreground mb-4">
              Projekt dla Graf Tapicerstwo to przykład, jak profesjonalne strona internetowa z galerią realizacji przekłada się
              na realne wyniki biznesowe. Profesjonalna strona z galerią realizacji przyciągnęła klientów z całej Polski szukających zabudowy busów. Fotz Studio realizuje podobne projekty
              dla firm z branży usług motoryzacyjnych i tapicerstwa i pokrewnych — każdorazowo z indywidualnym podejściem
            ...
            <h2 className="text-3xl font-heading font-bold mb-6">
              Potrzebujesz podobnego projektu? Sprawdź nasze usługi stron internetowych dla firm usługowych
            </h2>
            <p className="text-muted-foreground">
              Jeśli szukasz partnera do realizacji projektu podobnego do Graf Tapicerstwo, zapraszamy
