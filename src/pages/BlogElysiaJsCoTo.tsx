...
export default function BlogElysiaJsCoTo() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-fuchsia-950 to-pink-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Elysia.js i Bun 2024", url: "/blog/elysia-js-hono-bun-backend-typescript-frameworki-2024" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="elysia-js-hono-bun-backend-typescript-frameworki-2024" />
      <ContactSection />
    </Layout>
  );
}
