...
export default function BlogMultithreadingSprzedaz() {
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <PageBreadcrumbs items={[
              { name: "Home", url: "/" },
              { name: "Blog", url: "/blog" },
              { name: "Multithreading", url: "/blog/multithreading-sprzedaz-b2b-buying-committee" },
            ]}/>
          <div className="mt-8">
      ...
      <RelatedArticles currentArticleId="multithreading-sprzedaz-b2b-buying-committee" />
      <ContactSection />
    </Layout>
  );
}
